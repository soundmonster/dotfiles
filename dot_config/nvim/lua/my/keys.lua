return {
  ...
  { "<leader>fg",  "<cmd>lua Snacks.picker.grep()<cr>",                                           desc = "search text in files", },
  ...
  { "<leader>st",  "<cmd>AerialToggle!<cr>",                                                      desc = "toggle symbols" },
  { "<leader>ss",  "<cmd>lua Snacks.picker.lsp_symbols()<cr>",                                    desc = "symbol search" },
  { "<leader>sw",  "<cmd>lua Snacks.picker.lsp_workspace_symbols()<cr>",                          desc = "workspace symbol search" },
